/*
Deployment script for Cortex-ConfigStore
...
:setvar MachineName "LIVE_DBServerName"
...
:setvar DatabaseName "Cortex-ConfigStore"
:setvar DefaultFilePrefix "Cortex-ConfigStore"
...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [Cortex_ConfigStore_Data], FILENAME = '$(DatabaseFilePath)\$(DatabaseName)\Datafile\$(DatabaseName).mdf')
    LOG ON (NAME = [Cortex_ConfigStore_log], FILENAME = '$(DatabaseLogPath)\$(DatabaseName)\Logfile\$(DatabaseName).ldf') COLLATE SQL_Latin1_General_CP1_CI_AS
GO
IF EXISTS (SELECT 1
...
IF NOT EXISTS (SELECT * FROM sys.server_principals WHERE name = N'$(CortexDBUser)')
BEGIN TRY
	CREATE LOGIN [$(CortexDBUser)] FROM WINDOWS WITH DEFAULT_DATABASE=[master]
	PRINT 'Created login $(CortexDBUser)'
END TRY
BEGIN CATCH
	PRINT '$(CortexDBUser) login does not exist'
END CATCH 
...
GO
PRINT N'Creating Table [dbo].[ADGroup]...';
...
CREATE TABLE [dbo].[ADGroup] (
    ...
    CONSTRAINT [PK_ADGroup] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [unq_ADGroupConstraint] UNIQUE NONCLUSTERED ([GroupName] ASC)
);


GO
PRINT N'Creating Table [dbo].[AreaADGroupsLink]...';


GO
CREATE TABLE [dbo].[AreaADGroupsLink] (
    [ID]        INT NOT NULL,
    [AreaID]    INT NOT NULL,
    [ADGroupID] INT NOT NULL,
    CONSTRAINT [PK_AreaADGroupsLink] PRIMARY KEY CLUSTERED ([ID] ASC)
);
...
CREATE TABLE [dbo].[Areas] (
    ...
    CONSTRAINT [PK_Areas-v2] PRIMARY KEY CLUSTERED ([ID] ASC) ON [PRIMARY],
    CONSTRAINT [Area_Unique] UNIQUE NONCLUSTERED ([Area] ASC) ON [PRIMARY]
) ON [PRIMARY];
...
CREATE TABLE [dbo].[Customers] (
    ...
    [Description] VARCHAR (50) NULL,
    CONSTRAINT [PK_Customers-v2] PRIMARY KEY CLUSTERED ([ID] ASC) ON [PRIMARY],
    CONSTRAINT [Cust_Unique] UNIQUE NONCLUSTERED ([Customer] ASC) ON [PRIMARY]
) ON [PRIMARY];


GO
PRINT N'Creating Table [dbo].[Environments]...';
...
CREATE TABLE [dbo].[Environments] (
    ...
    [Description] VARCHAR (50) NULL,
    CONSTRAINT [PK_Environments-v2] PRIMARY KEY CLUSTERED ([ID] ASC) ON [PRIMARY],
    CONSTRAINT [Env_Unique] UNIQUE NONCLUSTERED ([Environment] ASC) ON [PRIMARY]
) ON [PRIMARY];


GO
PRINT N'Creating Table [dbo].[Param_Name]...';
...
CREATE TABLE [dbo].[Param_Name] (
    ...
    [Description] VARCHAR (500) NULL,
    CONSTRAINT [PK_Param_Name-v2] PRIMARY KEY CLUSTERED ([ID] ASC) ON [PRIMARY],
    CONSTRAINT [Prm_Unique] UNIQUE NONCLUSTERED ([Param_Name] ASC) ON [PRIMARY]
) ON [PRIMARY];


GO
PRINT N'Creating Table [dbo].[Param_Values]...';
...
CREATE TABLE [dbo].[Param_Values] (
    ...
    [Description]   VARCHAR (500) NULL,
    CONSTRAINT [PK_Param_Values-v2] PRIMARY KEY CLUSTERED ([ID] ASC) ON [PRIMARY],
    CONSTRAINT [unique_prm] UNIQUE NONCLUSTERED ([AreaID] ASC, [CustomerID] ASC, [EnvironmentID] ASC, [Param_NameID] ASC) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];


GO
PRINT N'Creating Table [dbo].[SYS_Sequence]...';
...
GO
PRINT N'Creating Table [dbo].[SYS_SETTINGS]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Param_Values_Areas]...';


GO
ALTER TABLE [dbo].[Param_Values]
    ADD CONSTRAINT [FK_Param_Values_Areas] FOREIGN KEY ([AreaID]) REFERENCES [dbo].[Areas] ([ID]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Param_Values_Customers]...';


GO
ALTER TABLE [dbo].[Param_Values]
    ADD CONSTRAINT [FK_Param_Values_Customers] FOREIGN KEY ([CustomerID]) REFERENCES [dbo].[Customers] ([ID]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Param_Values_Environments]...';


GO
ALTER TABLE [dbo].[Param_Values]
    ADD CONSTRAINT [FK_Param_Values_Environments] FOREIGN KEY ([EnvironmentID]) REFERENCES [dbo].[Environments] ([ID]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Param_Values_Param_Name]...';


GO
ALTER TABLE [dbo].[Param_Values]
    ADD CONSTRAINT [FK_Param_Values_Param_Name] FOREIGN KEY ([Param_NameID]) REFERENCES [dbo].[Param_Name] ([ID]);


GO
PRINT N'Creating View [dbo].[CFG_View]...';
...
AS
	...
	ORDER BY A.Area,
		     ...
		     PN.Param_name
GO
PRINT N'Creating View [dbo].[CGF_All_Permutations]...';
...
GO
PRINT N'Creating Function [dbo].[udf_Get_Parameter_Value]...';
...
END
GO
PRINT N'Creating Function [dbo].[udf_GetSequenceNumber]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TRG_InsteadOfInsert_ADGroup]...';


GO

CREATE TRIGGER [dbo].[TRG_InsteadOfInsert_ADGroup]
   ON  [dbo].[ADGroup]
...
BEGIN
	...
	DECLARE  @ADGroupID int = (SELECT dbo.udf_GetSequenceNumber('ADGroup','ID'));

	BEGIN TRY
		BEGIN TRANSACTION

			INSERT INTO ADGroup (ID
							,GroupName)
			SELECT @ADGroupID
				  ,inserted.GroupName
			FROM  inserted
			...
			UPDATE SYS_Sequence
			SET    SequenceNumber = @ADGroupID + 1
			WHERE  TableName = 'ADGroup'
			AND    ColumnName = 'ID'
...
END
GO
PRINT N'Creating Trigger [dbo].[TRG_InsteadOfInsert_AreaADGroupsLink]...';


GO
CREATE TRIGGER [dbo].[TRG_InsteadOfInsert_AreaADGroupsLink]
   ON  [dbo].[AreaADGroupsLink]
   INSTEAD OF INSERT NOT FOR REPLICATION
AS 
BEGIN
	SET NOCOUNT ON;

	DECLARE  @AreaADGroupsLinkID int = (SELECT dbo.udf_GetSequenceNumber('AreaADGroupsLink','ID'));

	BEGIN TRY
		BEGIN TRANSACTION

			INSERT INTO AreaADGroupsLink (ID
							,AreaID
							,ADGroupID)
			SELECT @AreaADGroupsLinkID
				  ,inserted.AreaID,inserted.ADGroupID
			FROM  inserted

			UPDATE SYS_Sequence
			SET    SequenceNumber = @AreaADGroupsLinkID + 1
			WHERE  TableName = 'AreaADGroupsLink'
			AND    ColumnName = 'ID'
...
END
GO
PRINT N'Creating Trigger [dbo].[TRG_InsteadOfInsert_Areas]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TRG_InsteadOfInsert_Customers]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TRG_InsteadOfInsert_Environments]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TRG_InsteadOfInsert_Param_Name]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TRG_InsteadOfInsert_Param_Values]...';
...
END
GO
PRINT N'Creating Function [dbo].[udf_split_string]...';
...
-- Description:	comma separated values to list
-- =============================================
...
GO
PRINT N'Creating Procedure [dbo].[usp_Get_Job_Status]...';
...
return @status
GO
PRINT N'Creating Procedure [dbo].[usp_InsertUpdate_ParamValues]...';
...
CREATE PROCEDURE [dbo].[usp_InsertUpdate_ParamValues] 
	-- Add the parameters for the stored procedure here
		...
		@i_sDescription varchar(500) = NULL,
...
END
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Add_Article]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Create_LogReader_Job]...';
...
EndSave:
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Create_QueueReader_Job]...';
...
EndSave:
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Create_Replicate_Job]...';
...
EndSave:
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Create_Snapshot_Job]...';
...
EndSave:
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_CreateDefaultData]...';
...
END CATCH
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Drop_Publication]...';
...
AS
  ...
  END
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Remove_Replication]...';
...
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Setup_Replication]...';
...
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Start_Job]...';
...
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Add_Publication]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[usp_REPL_Add_Subscription]...';
...
PRINT N'Creating Procedure [dbo].[usp_REPL_Create_Publication_CFG_Transactional]...';
...
-- =================================================================================
-- Update Author:Joe Lees
-- Update Date:  28/02/2019
-- Description:  Adds relevant Config Items to required SYS_ tables
-- Execute the Procedure to create partitioned tables
-- =================================================================================
...
--IF NOT EXISTS (SELECT 1 FROM SYS_SETTINGS WHERE [KEY] = 'Partitioned_Table_Suffix_Length')
--BEGIN
--	INSERT INTO SYS_SETTINGS ([KEY], [VALUE])
--	VALUES ('Partitioned_Table_Suffix_Length', '3')
...
--DECLARE @partitionThreshold int
--SET @partitionThreshold = $(retentionLengthHours) * 2

-- should we first truncate in case? / if exists?
-- insert data from SQLCMD Vars
--INSERT INTO SYS_PART_Config (View_Name, Partitioning_Column, No_Of_Live_Partitions, Live_Partition_Lifetime_Hours, Live_Partition_Threshold_Hours, No_Of_Historical_Partitions, Fileset)
--VALUES	('EventLog', 'EventTime', $(numPartitions), $(retentionLengthHours), @partitionThreshold, 0, 'PRIMARY'), 
--		('ProcessLog', 'ProcessStartTime', $(numPartitions), $(retentionLengthHours), @partitionThreshold, 0, 'PRIMARY'),
--		('StageLog', 'StageStartTime', $(numPartitions), $(retentionLengthHours), @partitionThreshold, 0, 'PRIMARY'),
--		('ParameterLog', 'InsertTime', $(numPartitions), $(retentionLengthHours), @partitionThreshold, 0, 'PRIMARY')

--INSERT INTO SYS_PART_Views (Partitioned_View_Name, Master_View_Name)
--VALUES	('EventLog', 'EventLog'),
--		('ProcessLog', 'ProcessLog'),
--		('StageLog', 'StageLog'),
--		('ParameterLog', 'ParameterLog')

-- Call procedure to create the Partitioned Tables
-- exec usp_PART_CreatePartition

-- Create the scheduled job
--:r .\Jobs\MaintainPartitions.sql 
--exec msdb.dbo.sp_start_job @job_name = '$(DatabaseName) Partitioning'
...
-- Give the DB User permissions to call the procedures
GRANT EXECUTE ON [dbo].[usp_InsertUpdate_ParamValues] TO [$(CortexDBUser)];
